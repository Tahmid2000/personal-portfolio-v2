...
function App() {
  return (
    <React.Fragment>
      <a id="button-right" className="hidden lg:block md:block cursor-pointer mr-12 mt-7 transition duration-200 ease-in-out bg-white border-2 border-black py-2 px-4 rounded-xl float-right hover:bg-black hover:text-white hover:border-black-500" href={Pdf} target="_blank" >Resume</a>
        ...
        <div className="m-auto">
          <div className="text-center">
            ...
            <div class="flex justify-center">
              <a className="cursor-pointer mt-4 transition duration-200 ease-in-out bg-white border-2 border-black py-2 px-4 w-32 rounded-xl hover:bg-black hover:text-white hover:border-black-500 block lg:hidden md:hidden" href={Pdf} target="_blank" >Resume</a>
            </div>
          </div>
        </div>
      </div>
